    ...
    <form id="form3" name="form3" method="post" action="">
      <table width="540" border="0" cellspacing="0" cellpadding="0" background="images/back11_2.gif">
        <tr>
          ...
          <td width="505" align="left" background="images/board04.gif">&nbsp; <span class="font_black">親愛的會員[</span><span class="font_red">&nbsp; &nbsp;</span><span class="font_black">]請由下方編輯您的個人資料~~</span></td>
